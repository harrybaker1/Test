    ...
    public static void main(String[] args)
    {
        ...
        while(!done && charIndex < solutionLength)
        {
            ...
            switch(direction)
            {
                ...
                default:
                    System.out.println("You have no idea where your going."); // Invalid direction.
            }
                ...
                || currentRow >= grid.length || currentCol >= grid[currentRow].length)
            {
                ...
                System.out.println("MESSAGE You fall into the chasm of doom."); // Out of bounds.
            }
            else
            {
                ...
                else if(grid[currentRow][currentCol] == WALL)
                {
                    ...
                    System.out.println("You stumble blindly into a solid conrete wall."); // Hit wall.
                }
